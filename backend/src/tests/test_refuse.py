...
def db_override():
    """Temporarily overrides get_db dependency and restores it after."""
...
class TestEvaluateRefuseIntegration:
    def test_evaluate_returns_refuse_on_two_l3_anchors(self, client, two_l3_anchors, auth_headers):
        resp = client.post(
            "/gate/evaluate",
            json={
...
class TestReframeRefuseIntegration:
    def test_reframe_rejects_refused_parent(self, client, two_l3_anchors, auth_headers):
